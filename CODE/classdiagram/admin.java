...
public class admin implements Login{
	...
	public int add(String stf_id,String stf_name, String srv_id,int paym,String srv_name,String phn)
	{
			try {
		        ...
		        cl = DriverManager.getConnection("jdbc:postgresql://localhost:5432/project", "postgres", "2002"); 
	...
	public int add(String service_id,String service_name)
	{
		try {
			Connection c =null;
			Class.forName("org.postgresql.Driver");
	        c = DriverManager.getConnection("jdbc:postgresql://localhost:5432/project", "postgres", "2002");
